"""
Django settings for the_taz project.
...
SECRET_KEY ='+=bgw&=8a5gt^rgiy7bz+k6gxlcv-_sgmxen%+f-um_$$)sbv$'

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = os.getenv('DJANGO_DEBUG')
DEBUG = True
ALLOWED_HOSTS = ['cellers.herokuapp.com','127.0.0.1']
...
WSGI_APPLICATION = 'the_taz.wsgi.application'
